...
class Composer_jieba:
    ...
    def set_config(self, filename_stopwords='stop_words.txt', filename_idf='idf_train_120000.txt',
    ...
    @timing
    def _load_kw_config(self, filename_stopwords='stop_words.txt', filename_idf='idf_train_120000.txt'):
        ...
        os.path.join(foler_path, filename_stopwords)
...
if __name__ == '__main__':
    ...
    jieba_base = Composer_jieba()
    # jieba_base.set_config(filename_idf='idf_train_1000000.txt') #idf_train_120000
